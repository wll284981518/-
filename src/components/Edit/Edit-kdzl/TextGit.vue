	...
	<div class="textgit">
		<div class="git-header">
			<div class="git-header-left">
				<router-link to="/edit" tag="div" class="git-header-left">
		...
		<div class="git-concent">
			<div class="con-left">
				<div class="left-list">
					<router-link tag="div" to="/textgit/ples" class="left-list">
						求导题库
					</router-link>
				</div>
				<div class="left-list">
					<router-link tag="div" to="/textgit/limit" class="left-list">
						极限题库
					</router-link>
				</div>
				<div class="left-list">
					<router-link tag="div" to="/textgit/biology" class="left-list">
						生物
					</router-link>
				</div>
				<div class="left-list">
					<router-link tag="div" to="/textgit/chemistry" class="left-list">
						化学
					</router-link>
				</div>
				<div class="left-list">
					<router-link tag="div" to="/textgit/mathematics" class="left-list">
						数学
					</router-link>
				</div>
				<div class="left-list">
					<router-link tag="div" to="/textgit/physics" class="left-list">
						物理
					</router-link>
				</div>
				<div class="left-list">
					<router-link tag="div" to="/textgit/english" class="left-list">
						英语
					</router-link>
				</div>
			</div>
